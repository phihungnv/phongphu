            ...
            '<table class="form-table">'.
                    ...
                    ?
                        '<tr valign="top">'.
                            '<td colspan="2">'.
                                ...
                                '<label for="ajaxhc_use_rapid_incrementer">&nbsp;'.__( 'Use very fast ("rapid") Hits Counter Script', $this->plugin_alias ).'</label>'.
                            '</td>'.
                        '</tr>'
                    :
                        ''
                ...
                '<tr valign="top">'.
                    '<td colspan="2">'.
                        ...
                        '<label for="ajaxhc_dont_count_admins">&nbsp;'.__( 'Don\'t count hits of admin users (only for non "rapid" Hits Counter Script)', $this->plugin_alias ).'</label>'.
                    '</td>'.
                '</tr>'.
            '</table>'
            );
