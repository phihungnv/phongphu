...
<div class="search-area product-search-area">
	<form method="get" action="<?php echo esc_url( home_url( '/'  ) ); ?>">
		<div class="input-group">
        	...
        	<input type="text" id="search" class="search-field" dir="<?php echo esc_attr( $dir_value ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" placeholder="<?php echo esc_attr( esc_html__( 'Nhập tên sản phẩm', 'unicase' ) ); ?>" />
